...
% tetracosane C24
 ...
 pv1 = [0.001619 0.001667 0.002398 0.002976 0.003789 0.010386 0.018751 0.025737 0.037634];
 pL1 = [0.604481 0.596667 0.588530 0.581371 0.567082 0.516721 0.498091 0.466649 0.428144]; 
...
for g=1:length(A_range)
    ...
    for h=1:length(b_range)
       ...
       SE = (y1 - (pc_range(i) + A_range(g)*(TC_range(j)-T1))).^2 + (z1 - (b_range(h)*(TC_range(j)-T1).^beta)).^2;
