...
b_range1 = 0.1036:0.0008:0.1084;
pc_range1 = 0.203:0.0025:0.219;
TC_range1 = 806:5:828;
...
% b_range2 = 0.103:0.001:0.1078;
% pc_range2 = 0.201:0.0025:0.217;
% TC_range2 = 815:3:840;
...
b_range3 = 0.1008:0.001:0.1087;
pc_range3 = 0.197:0.0025:0.217;
TC_range3 = 820:5:855;
...
% These confidence regions are for the co-confidence of pC
% confidence_region12 = ones(length(pc_range1),length(pc_range2));
confidence_region13 = ones(length(pc_range1),length(pc_range3));
...
%             confidence_region12(i1,i2) = 0;
            confidence_region13(i1,i3) = 0;
...
% contour(pc_range2,pc_range1,confidence_region12)
contour(pc_range3,pc_range1,confidence_region13)
